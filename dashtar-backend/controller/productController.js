...
const addProduct = async (req, res) => {
  console.log(mongoose.Types.ObjectId(req.body.adminId));
  try {
...
const getAllProducts = async (req, res) => {
  ...
  const { title, category, price, page, limit , adminId} = req.query;
  let queryObject = { adminId: mongoose.Types.ObjectId(adminId) };
  let sortObject = {};
  if (title) {
    queryObject.$or = [
