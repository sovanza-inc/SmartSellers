  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (location.pathname === "/platforms") {
        if (ids) {
          // Logic for deleting multiple platforms
          const res = await PlatformServices.deleteManyPlatforms({ ids: ids });
          ...
          // Logic for deleting a single platform
          const res = await PlatformServices.deletePlatform(id);
          // Handle the response and UI updates
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
      ...
      if (location.pathname === "/subscriptions") {
        if (ids) {
          ...
          const res = await SubscriptionServices.deleteManySubscriptions({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
          ...
          const res = await SubscriptionServices.deleteSubscription(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
          closeModal();
